...
Magnetic fields are present in nearly all stars and substellar objects during every stage of their temporal evolution \citep[hereafter (sub)stellar evolution;][]{Donati2009}. (Sub)Stellar magnetic fields come in two flavors: (1) dynamo-generated fields, or magnetic fields that are actively created and sustained by internal dynamical processes, and (2) fossil/remnant fields, which are not actively created or sustained by dynamical processes. Magnetic fields, in particular dynamo-generated fields, influence a range physical processes and may ultimately help govern (sub)stellar interior structure and evolution. However, investigations studying the role magnetic fields play in regulating physical phenomena regularly neglect the intimate, reciprocal relationship between stellar structure and magnetic field properties. 
...
This proposal aims to understand the relationship between the structural evolution of stars and substellar objects and dynamo-generated magnetic fields. That is, to investigate how the properties of dynamo-generated magnetic fields are affected by (sub)stellar structure over time, as well as how (sub)stellar structure is influenced by the presence of magnetic fields. Furthermore, the proposal seeks to deepen understanding about relationship between dynamo-generated magnetic fields at during early stages of evolution and remnant/fossil magnetic fields that exist at later evolutionary stages.

The research program will rely on theoretical modeling of stellar structure and evolution coupled with 
the coupling of a sophisticated stellar structure and evoluti	on model with a detailed mean-field magnetic dynamo model. The former was developed specifically to treat the effects of magnetic fields on stellar structure while the latter provides a realistic description of the magnetic fields generation
